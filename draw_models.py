...
def Neural_Network_Graph(input_layer, hidden_layers, output_layer, filename='F:\python.'):
    ...
    g.render(filename='MyPicture', directory="F:\python",format="png", view=True)

input_layer = 10  # 输入层的神经元数量
hidden_layers = [16, 16, 8]  # 隐藏层层数和数量
